<div class="container1">
                        <div class="title">
                            <p class="new-product">Sản phẩm mới tháng 11</p>
                        </div>
                        <ul id="autoWidth" class="cs-hidden">
                            <!-----1-->
                            <li class="item-a">
                                <div class="box">
                                    <img src="/doan/Public/Asset/Img/new-product-7.jpg" class="model" alt="n-p1">
                                    <div class="detail">
                            ...
                            <li class="item-a">
                                <div class="box">
                                    ...
                                    <div class="detail">
                                        ...
                                        <div class="price-del">
                                            <del>13,960,000₫</del>
                                            <div class="price">11,390,000₫</div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="item-a">
                                <div class="box">
                                    <a href = 'detail-product.php'><img src="/doan/Public/Asset/Img/new-product-1.jpg" class="model" alt="n-p1"></a>
                                    <div class="detail">
                            ...
                            <li class="item-a">
                                <div class="box">
                                    <img src="/doan/Public/Asset/Img/new-product-8.jpg" class="model" alt="n-p1">
                                    <div class="detail">
